...
const log = aurelia_logging_1.getLogger('checker-flow-dialog');
let CheckerFlowDialog = class CheckerFlowDialog {
    ...
    activate(params) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (params.flow && params.flow instanceof checker_internals_1.CheckerFlowModel) {
                this.flow = params.flow;
                this.siteId = this.flow.siteId;
                this.mode = 'edit';
            }
            else if (params.flowId) {
                const flow = yield checker_internals_1.CheckerFlowModel.getOneWithId(params.flowId);
                if (!flow) {
    ...
    canDeactivate(result) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (result.output === 'remove') {
                const reports = yield checker_report_model_1.ThreeCheckerReportModel.getAll(`?siteId=${this.siteId}&flows=${this.flow.id}`);
    ...
    addModule() {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                if (!result.wasCancelled) {
                    const instance = checker_internals_1.CheckerModuleBaseModel.create({ moduleType: result.output, siteId: this.flow.siteId });
                    if (instance) {
    ...
    fetchModules() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            for (const moduleId of this.flow.modulesIds) {
                const mod = yield checker_internals_1.CheckerModuleBaseModel.getOne(this.flow.id, moduleId);
                modules.push(mod);
            }
    ...
    fetchKeyValues() {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const response = yield checker_internals_1.CheckerFlowModel.api.get(`/three/site/${this.flow.siteId}/key-values`);
    ...
    testFlow() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const json = yield this.flow.api.post(`/three/checker/flow/${this.flow.id}/run`).then(aurelia_deco_1.jsonify);
    ...
    duplicate() {
        return __awaiter(this, void 0, void 0, function* () {
            const duplicatedFlow = new checker_internals_1.CheckerFlowModel;
            ...
            for (const module of this.modules) {
                const newModule = checker_internals_1.CheckerModuleBaseModel.create(module);
