...
class ThreeTranslationTool extends three_tool_1.ThreeTool {
    constructor() {
        super(...arguments);
        this.name = 'translate';
        ...
        this.subscriptions = [];
        this.log = aurelia_logging_1.getLogger('three-admin-translation');
    }
    ...
    handlePlanesIntersects(data) {
        ...
        if (data.type === 'down') {
            ...
            let constraintsTranslateVector;
    ...
    updateGhostPosition(object, vector) {
