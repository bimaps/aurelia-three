...
const ColladaLoader_1 = require("three/examples/jsm/loaders/ColladaLoader");
const THREE = require("three");
window.THREE = THREE;
const aurelia_event_aggregator_1 = require("aurelia-event-aggregator");
class ThreeObjects {
    constructor(three) {
        this.log = aurelia_logging_1.getLogger('three-objects');
        this.subscriptions = [];
        this.offset = null;
        this.bbox = null;
...
__decorate([
    aurelia_framework_1.computedFrom('scene.children', 'scene.children.length'),
