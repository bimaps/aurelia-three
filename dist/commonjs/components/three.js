...
exports.MainScene = exports.ThreeCustomElement = void 0;
const three_points_1 = require("./../helpers/three-points");
const three_objects_1 = require("../helpers/three-objects");
const three_navigation_1 = require("../helpers/three-navigation");
...
let ThreeCustomElement = class ThreeCustomElement {
    constructor(element) {
        ...
        this.log = aurelia_logging_1.getLogger('comp:three');
        this.handleResize = (e) => {
    ...
    publish(event, data) {
        aurelia_framework_1.Container.instance.get(aurelia_event_aggregator_1.EventAggregator).publish(`three-${event}`, data);
    }
    init() {
        this.log.debug('init');
        this.initScene();
        this.initCamera();
        this.navigation = new three_navigation_1.ThreeNavigation(this);
        this.navigation.initControls();
        window.navigation = this.navigation;
        this.initLight();
        this.objects = new three_objects_1.ThreeObjects(this);
        this.log.debug('scene', this.scene);
        this.log.debug('camera', this.camera);
        this.points = new three_points_1.ThreePoints(this);
    }
    initScene() {
...
ThreeCustomElement = __decorate([
    aurelia_framework_1.customElement('three'),
    aurelia_framework_1.inject(Element),
    __metadata("design:paramtypes", [HTMLElement])
], ThreeCustomElement);
exports.ThreeCustomElement = ThreeCustomElement;
