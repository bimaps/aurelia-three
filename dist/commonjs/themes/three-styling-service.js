...
var three_geometry_1 = require("./three-geometry");
...
var three_icon_1 = require("./three-icon");
var ThreeStylingService = (function () {
    ...
    ThreeStylingService.prototype.applyTheme = function (objects, theme, context, options) {
        ...
        for (var _i = 0, objects_1 = objects; _i < objects_1.length; _i++) {
            ...
            rootObject.traverse(function (object) {
                ...
                var definition = new three_style_definition_1.ThreeStyleDefinition();
                    ...
                    if (rule.applyToChildren) {
                        object.traverse(function (child) {
                            if (child === object)
                                return;
                            var uuid = child.uuid;
                            var def = childrenDefinitions[uuid] ? childrenDefinitions[uuid] : new three_style_definition_1.ThreeStyleDefinition();
    ...
    ThreeStylingService.prototype.addObjectLabel = function (object, definition) {
        ...
        if (object.userData.__labelPosition) {
            ...
            var bbox = three_utils_1.ThreeUtils.bboxFromObject(object);
            if (definition.labelCentroidMethod === 'polylabel' && object instanceof THREE.Mesh) {
                position = three_utils_1.ThreeUtils.polylabel(object, bbox.min.y);
            }
            else {
        ...
        if (definition.labelTemplate) {
            text = aurelia_resources_1.Parser.parseTemplate(definition.labelTemplate, { object: object });
        }
        else {
    ...
    ThreeStylingService.prototype.addLabel = function (name, text, position, scale, options) {
        ...
        if (typeof scale !== 'number' || Number.isNaN(scale))
            scale = 1;
        var sprite = new three_text2d_1.SpriteText2D(text, {
    ...
    ThreeStylingService.prototype.addIcon = function (objectName, iconName, position, scale, options) {
        ...
        return three_icon_1.ThreeIcon.getTexture(iconName, options.backgroundColor, options.strokeColor, options.text).then(function (texture) {
            if (!texture) {
    ...
    ThreeStylingService.prototype.replaceObjectGeometry = function (object, definition) {
        var o = object;
        var position = three_utils_1.ThreeUtils.centroidFromObject(object);
        ...
        var geometry = three_geometry_1.ThreeGeometry.get(definition.geometryShape);
