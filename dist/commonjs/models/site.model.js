...
var geometry_model_1 = require("./geometry.model");
var object_model_1 = require("./object.model");
var aurelia_deco_1 = require("aurelia-deco");
var THREE = require("three");
var aurelia_logging_1 = require("aurelia-logging");
var log = aurelia_logging_1.getLogger('three-site-model');
;
var ThreeSiteModel = (function (_super) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4, ThreeSiteModel_1.api.post(url, formData, { bodyFormat: 'FormData' }).then(aurelia_deco_1.jsonify)];
                    case 1:
                        result = _a.sent();
    ...
    ThreeSiteModel.waitForOperationCompleted = function (siteId, operationId) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4, ThreeSiteModel_1.api.get("/three/site/" + siteId + "/import/ifc/" + operationId).then(aurelia_deco_1.jsonify)];
                    case 1:
                        result = _a.sent();
