...
var CheckerModuleProjectionElement = (function () {
    function CheckerModuleProjectionElement(modalService, element) {
        this.modalService = modalService;
        this.element = element;
        this.inputOptions = [];
        this.opened = true;
    }
    CheckerModuleProjectionElement.prototype.triggerChange = function () {
        var customEvent = DOM.createCustomEvent('change', { bubbles: true });
        this.element.dispatchEvent(customEvent);
    };
    CheckerModuleProjectionElement.prototype.toggle = function () {
    ...
    return CheckerModuleProjectionElement;
}());
