...
var log = getLogger('checker-flow-dialog');
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        if (!(params.flow && params.flow instanceof CheckerFlowModel)) return [3, 1];
                    ...
                    case 1:
                        ...
                        return [4, CheckerFlowModel.getOneWithId(params.flowId)];
                    case 2:
                        flow = _a.sent();
                        if (!flow) {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        return [4, ThreeCheckerReportModel.getAll("?siteId=" + this.siteId + "&flows=" + this.flow.id)];
                    case 1:
                        reports = _b.sent();
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        instance = CheckerModuleBaseModel.create({ moduleType: result.output, siteId: this.flow.siteId });
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        moduleId = _a[_i];
                        return [4, CheckerModuleBaseModel.getOne(this.flow.id, moduleId)];
                    case 2:
                        mod = _b.sent();
                        modules.push(mod);
                        _b.label = 3;
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
                        return [4, CheckerFlowModel.api.get("/three/site/" + this.flow.siteId + "/key-values")];
                    case 1:
                        response = _a.sent();
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                        return [4, this.flow.api.post("/three/checker/flow/" + this.flow.id + "/run").then(jsonify)];
                    case 2:
                        json = _a.sent();
    ...
    CheckerFlowDialog.prototype.duplicate = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        duplicatedFlow = new CheckerFlowModel;
                    ...
                    case 3:
                        ...
                        module_2 = _a[_i];
                        newModule = CheckerModuleBaseModel.create(module_2);
