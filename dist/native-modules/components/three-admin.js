...
var ThreeAdmin = (function () {
    ...
    ThreeAdmin.prototype.getSites = function () {
        var _this = this;
        ThreeSiteModel.getAll().then(function (sites) {
            _this.sites = sites;
    ...
    ThreeAdmin.prototype.generate = function (type) {
        var _a;
        var generator = new ThreeGenerator();
        if (type === 'cube') {
    ...
    ThreeAdmin.prototype.deleteSite = function (site) {
        var _this = this;
        arDialog({ title: 'Delete Site ?', content: 'Are you sure that you want to delete this site and all the data related to this site in the API ?', type: 'confirmation' }).whenClosed().then(function (result) {
            ...
            if (!result.dismissed && result.agree) {
                ...
                return ThreeSiteModel.clearData(site.id).then(function () {
    ...
    ThreeAdmin.prototype.clearSiteData = function (siteId) {
        ...
        return arDialog({ title: 'Clear Data ?', content: 'Are you sure that you want to delete all the data related to this site in the API ?', type: 'confirmation' }).whenClosed().then(function (result) {
            if (!result.dismissed && result.agree) {
                _this.currentOperation = 'Clearing Site Data';
                return ThreeSiteModel.clearData(siteId).then(function () {
    ...
    ThreeAdmin.prototype.createSite = function () {
        var _this = this;
        arDialog({ title: 'Site Name', type: 'prompt' }).whenClosed().then(function (result) {
            if (result.value && !result.dismissed) {
                var newSiteId_1;
                var site = new ThreeSiteModel();
    ...
    ThreeAdmin.prototype.renameSite = function (site) {
        ...
        arDialog({ title: "Rename site " + currentName, type: 'prompt' }).whenClosed().then(function (result) {
            if (result.value && !result.dismissed) {
                site.name = result.value;
                site.updateProperties('', ['name']).then(function (updatedSite) {
                    site.name = updatedSite.name;
    ...
    ThreeAdmin.prototype.loadSite = function (siteId) {
        var _this = this;
        arDialog({ title: 'Loading Settings', type: 'prompt', promptCompName: 'three-admin-dialog-load-data-api' }).whenClosed().then(function (result) {
            if (!result.dismissed) {
                ...
                var filters = {};
                ThreeSiteModel.getSiteJson(siteId, filters).then(function (json) {
    ...
    ThreeAdmin.prototype.saveSceneIntoSite = function () {
        ...
        if (!this.currentSite)
            return;
        return arDialog({ title: 'Saving Settings', type: 'prompt', promptCompName: 'three-admin-dialog-save-data-api' }).whenClosed().then(function (result) {
            if (!result.dismissed) {
                ...
                clearPromise.then(function () {
                    ...
                    return ThreeSiteModel.addJsonData(_this.currentSite.id, json, { importId: importId, saveLights: resp_2.saveLights });
        ...
        input.addEventListener('change', function () {
            ...
            if (input.files && input.files.length === 1) {
                ...
                if (file.name.substr(-4) === '.ifc') {
                    ...
                    ThreeSiteModel.addIFCData(_this.currentSite.id, file).then(function () {
                    ...
                    ThreeSiteModel.addJsonData(_this.currentSite.id, file).then(function () {
                        notify('Data successfuly uploaded', { timeout: 0 });
                    }).catch(function (error) { return _this.handleError(error); }).finally(function () {
                        _this.uploadingFile = false;
                    });
    ...
    ThreeAdmin.prototype.saveObjectProperties = function (object) {
        ...
        var obj = ThreeObjectModel.fromThreeObject(object);
    ...
    ThreeAdmin.prototype.addLight = function () {
        ...
        arDialog({ type: 'prompt', title: 'What kind of light ?', promptOptions: lightTypes }).whenClosed().then(function (result) {
    ...
    ThreeAdmin.prototype.manualRotate = function () {
        var _this = this;
        var ad = arDialog({ title: 'Manual Rotate', type: 'prompt', promptCompName: 'admin-dialog-manual-rotate' });
    ...
    ThreeAdmin.prototype.loadPoints = function () {
        var _this = this;
        arDialog({ title: 'Point Clouds Name', type: 'prompt', content: "Enter the name of the Point Clouds project you want to load, such as \"sextant\", \"cossonay\", \"saanen\", ..." }).whenClosed().then(function (result) {
            if (!result.dismissed && result.value) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _a = this;
                        return [4, ThreeCheckerConfigModel.getAll("?siteId=" + this.currentSite.id)];
                    case 1:
                        _a.checkers = _b.sent();
                        return [2];
                }
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _a = this;
                        return [4, CheckerFlowModel.getAll("?siteId=" + this.currentSite.id)];
                    case 1:
                        _a.flows = _b.sent();
                        return [2];
                }
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.trys.push([1, 7, , 8]);
                        return [4, ThreeSiteModel.api.get(requestUrl)];
                    case 2:
                        response = _a.sent();
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _a = this;
                        return [4, ThreeCheckerReportModel.getAll("?siteId=" + this.currentSite.id)];
                    case 1:
                        _a.reports = _b.sent();
                        return [2];
                }
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.trys.push([1, 7, , 8]);
                        return [4, ThreeCheckerReportModel.api.get(requestUrl)];
                    case 2:
                        response = _a.sent();
                        if (!(response.status !== 200)) return [3, 4];
                        return [4, response.json()];
    ...
    ThreeAdmin.prototype.getThemes = function () {
        var _this = this;
        ThreeThemeModel.getAll("?siteId=" + this.currentSite.id).then(function (themes) {
    ...
    ThreeAdmin.prototype.getStyles = function () {
        var _this = this;
        return ThreeStyleModel.getAll("?siteId=" + this.currentSite.id).then(function (styles) {
    ...
    ThreeAdmin.prototype.createNewTheme = function () {
        var _this = this;
        arDialog({ title: 'Create a theme', type: 'prompt', content: 'Theme name' }).whenClosed().then(function (result) {
            if (!result.dismissed && result.value) {
                var theme = new ThreeThemeModel;
    ...
    ThreeAdmin.prototype.saveTheme = function (theme) {
        ...
        if (theme instanceof ThreeThemeModel) {
            var keys_1 = Object.keys(ThreeThemeModel.deco.propertyTypes);
    ...
    ThreeAdmin.prototype.editThemeName = function (theme) {
        var _this = this;
        adDialogModel(theme, { title: 'Edit Theme Name' }, ['name']).whenClosed().then(function (result) {
        }).catch(function (error) { return _this.handleError(error); });
    };
    ...
    ThreeAdmin.prototype.addRule = function (theme) {
        var _this = this;
        arDialog({ title: 'Add New Rule', content: 'Rule Name', type: 'prompt' }).whenClosed().then(function (result) {
            if (!result.dismissed && result.value) {
                if (!Array.isArray(theme.rules))
                    theme.rules = [];
                var rule = new ThreeThemeModelRule();
    ...
    ThreeAdmin.prototype.createNewStyle = function () {
        var _this = this;
        arDialog({ title: 'Add New Style', content: 'Style Name', type: 'prompt' }).whenClosed().then(function (result) {
            if (!result.dismissed && result.value) {
                var style = new ThreeStyleModel();
                style.siteId = _this.currentSite.id;
                style.name = result.value;
                style.save().then(function () { return _this.getStyles(); }).catch(errorify);
            }
        });
    };
    ...
    ThreeAdmin.prototype.deleteStyle = function (style) {
        var _this = this;
        arDialog({ title: 'Delete Style', content: 'Do you confirm that you want to permanently delete this style ?', type: 'confirmation' }).whenClosed().then(function (result) {
            if (!result.dismissed && result.agree) {
